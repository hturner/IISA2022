...
Run the `documentation` chunk below to view your documentation.
...
Open the `tests.R` script. Using `expect_equal()` add some tests in `tests.R`
...
Run the `tests` chunk below to run your tests with `test_file`.
